"""
Django settings for CMS_Website_Project project.
...
SECRET_KEY = 'django-insecure-q@0o#l)$)vrh@$5z1x^gqwl=x$xmc_9pj-(9os=yplugxiuma)'
...
WSGI_APPLICATION = 'CMS_Website_Project.wsgi.application'
